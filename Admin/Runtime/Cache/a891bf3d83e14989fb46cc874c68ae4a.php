...
<?php if(is_array($list)): foreach($list as $key=>$co): ?><tr> <td><?php echo ($co["person_department"]); ?>--<?php echo ($co["person_name"]); ?></td>
		<td><a href='__APP__/Person/edit/id/<?php echo ($co["person_id"]); ?>'>修改</a></td>
		<td><a href='__APP__/Person/delete/id/<?php echo ($co["person_id"]); ?>'>删除</a></td>
	</tr><?php endforeach; endif; ?>
</table>
<div class="jogger">
<?php echo ($page); ?>
</div>
<p><a href="__APP__/Person/edit" class="btn bcm w3 mt20 tcw">新增</a></p>
				</block>
