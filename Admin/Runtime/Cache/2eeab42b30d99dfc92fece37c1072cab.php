...
<table class="table table-bordered">
	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>					
				<td><a href="__PUBLIC__/upload/file/<?php echo ($vo["file_path"]); ?>"><?php echo ($vo["filecate_name"]); ?>---<?php echo ($vo["file_name"]); ?>---<?php echo (date('Y-m-d',$vo["file_time"])); ?></a></td>
				<td><a href="__APP__/File/delete/id/<?php echo ($vo["file_id"]); ?>" class="text-center" >删除</a></td>
		</tr><?php endforeach; endif; ?>
</table>
<div class="jogger"><?php echo ($page); ?></div>
<p class="mt20"><a href="__APP__/File/add" class="btn bcm w3 tcw">新增</a></p>
