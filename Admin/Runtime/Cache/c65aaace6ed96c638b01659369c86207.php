...
<div>
	...
	<?php if(is_array($list)): foreach($list as $key=>$co): ?><tr> <td><?php echo ($co["name"]); ?>--<?php echo (date('Y-m-d',$co["time"])); ?></td>
			<td><a href='__APP__/Institution/edit/id/<?php echo ($co["id"]); ?>'>修改</a></td>
			<td><a href='__APP__/Institution/delete/id/<?php echo ($co["id"]); ?>'>删除</a></td>
		</tr><?php endforeach; endif; ?>
	</table>
	<div class="jogger"> <?php echo ($page); ?></div>
</div>
<p><a href='__APP__/Institution/edit' class="btn bcm w3 tcw">新增</a></p>
				</block>
