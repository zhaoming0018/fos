...
<?php if(is_array($list)): foreach($list as $key=>$co): ?><tr> <td><span class="tcm"><?php echo ($co["category"]); ?></span>--<?php echo ($co["title"]); ?>--<?php echo (date('Y-m-d',$co["time"])); ?></td>
		<td><a href='__APP__/News/edit/id/<?php echo ($co["id"]); ?>'>修改</a></td>
		<td><a href='__APP__/News/delete/id/<?php echo ($co["id"]); ?>'>删除</a></td>
		<!--<td><a href='__APP__/News/file/id/<?php echo ($co["id"]); ?>'>附件</a></td>-->
	</tr><?php endforeach; endif; ?>
</table>
<div class="jogger"><?php echo ($page); ?></div>
<p class="mt20"><a href="__APP__/News/edit" class="btn bcm w3 tcw">新增</a></p>
				</block>
