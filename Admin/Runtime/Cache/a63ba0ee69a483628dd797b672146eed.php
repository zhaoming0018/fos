...
<?php if(is_array($list)): foreach($list as $key=>$co): ?><tr>
	    <td><?php echo ($co["foreign_name"]); ?></td>
		<td><a href='__APP__/Enedu/edit/id/<?php echo ($co["foreign_id"]); ?>'>修改</a></td>
		<td><a href='__APP__/Enedu/delete/id/<?php echo ($co["foreign_id"]); ?>'>删除</a></td>
	</tr><?php endforeach; endif; ?>
</table>
<div class="jogger"><?php echo ($page); ?></div>
<p class="mt20"><a href='__APP__/Enedu/edit' class="btn bcm w3 tcw">新增</a></p>
				</block>
