...
<table class="table table-bordered">
	<?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<?php if(($vo["user_priority"]) == "0"): ?><td>总管理员</td>
				<td><span style="color:#999;">不可删除</span></td>
				<td><a href="__APP__/User/edit/username/<?php echo ($vo["user_name"]); ?>">更改</a></td>
				<?php else: ?>
				<td>普通管理员</td>
				<td><a href="__APP__/User/delete/username/<?php echo ($vo["user_name"]); ?>" style="color:red;">删除</a></td>
				<td><a href="__APP__/User/edit/username/<?php echo ($vo["user_name"]); ?>">更改</a></td><?php endif; ?>
	</tr><?php endforeach; endif; else: echo "" ;endif; ?>
</table>
<div><a href="__APP__/User/add" class="btn bcm w3" style="color:#fff;">添加用户</a></div>
