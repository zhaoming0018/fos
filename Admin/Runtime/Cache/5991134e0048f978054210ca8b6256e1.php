...
<table class="table table-bordered">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		<td><?php echo ($vo["denews_title"]); ?>--<?php echo (date('Y-m-d',$vo["denews_time"])); ?></td>
		<td><a href="__APP__/Develop/edit/id/<?php echo ($vo["denews_id"]); ?>">修改</a></td>
		<td><a href="__APP__/Develop/delete/id/<?php echo ($vo["denews_id"]); ?>">删除</a></td>
	</tr><?php endforeach; endif; else: echo "" ;endif; ?>
</table>
<div class="jogger"><?php echo ($page); ?></div>
<a href="__APP__/Develop/edit" class="btn bcm w3 tcw">新增</a>
