...
<div>
	...
	<?php if(is_array($list)): foreach($list as $key=>$co): ?><tr> <td><?php echo ($co["name"]); ?>--<?php echo (date('Y-m-d',$co["time"])); ?></td>
			<td><a href='__APP__/Endept/edit/id/<?php echo ($co["id"]); ?>'>修改</a></td>
			<td><a href='__APP__/Endept/delete/id/<?php echo ($co["id"]); ?>'>删除</a></td>
...
<p><a href='__APP__/Endept/edit' class="btn bcm w3 tcw">新增</a></p>
