...
<div class="container">
	...
	<div class="navList mb20">
		<div class="navTitle">系科简介</div><!-- 数据库读出数据 -->
		<ul>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/Department/index/id/<?php echo ($vo["department_id"]); ?>"><?php echo ($vo["department_name"]); ?></a></li><!-- 数据库读出 --><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
</div>	
		...
		<div class="w10 pull-left">
			<div class="article">
				<div class="articleTitle">
					<div><?php echo ($dept["department_name"]); ?></div>
					<hr/>
				</div>
				<div class="w9 center-block">
					<?php echo ($dept["department_content"]); ?>
				</div>
			</div>
		</div>
		<div class="clearfix"></div>
