...
<div class="container">
	<div class="row mt20">
		...
		<?php if(($_GET["title"]) == ""): ?><div class="w10 pull-left">
			<div class="article">
				...
				<div class="articleBody w9 center-block">
					<ul>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/Xsgz/gzzd/title/<?php echo ($vo["news_title"]); ?>" style="color:#000;"><?php echo ($vo["news_title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
					<div class="jogger"> 
						<?php echo ($page); ?>
					</div>
