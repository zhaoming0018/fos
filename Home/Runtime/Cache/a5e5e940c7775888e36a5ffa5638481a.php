...
<div class="container">
		...
		<div class="w2 pull-left">
			...
			<div class="navside">
				...
				<div class="navList mb20">
					...
					<div class="navTitle">下载中心</div><!-- 数据库读出数据 -->
	...
	width:90%;
 	...
 	line-height:30px;"><a href="__PUBLIC__/upload/file/<?php echo ($vo["file_path"]); ?>" class="along" title="<?php echo ($vo["file_name"]); ?>"><?php echo ($vo["file_name"]); ?></a><span style="position:absolute;

	display:inline-block;

	right:10px;" class="newsTime"><?php echo (date('[Y-m-d]',$vo["file_time"])); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>

					</ul>

					<div class="jogger" style="margin-left:100px;"> 
