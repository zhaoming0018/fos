		...
		<div class="w10 pull-left">
			<div class="article">
				...
				<div class="articleBody w9 center-block">
						...
						<?php $__FOR_START_25559__=1;$__FOR_END_25559__=8;for($i=$__FOR_START_25559__;$i < $__FOR_END_25559__;$i+=1){ ?><h4><?php echo ($department["$i"]); ?></h4>
							<table class="table  table-bordered">
								<?php $__FOR_START_13508__=0;$__FOR_END_13508__=$list["{$i}"]["count"];for($j=$__FOR_START_13508__;$j < $__FOR_END_13508__;$j+=1){ if(($j%5) == "0"): ?><tr><?php endif; ?>
									<td>									<?php if(($list["{$i}"]["{$j}"]["desc"]) == ""): echo ($list["$i"]["$j"]["name"]); ?>									<?php else: ?>									<a href="__APP__/Teacher/show/id/<?php echo ($list["$i"]["$j"]["id"]); ?>"><?php echo ($list["$i"]["$j"]["name"]); ?></a></td><?php endif; ?>
