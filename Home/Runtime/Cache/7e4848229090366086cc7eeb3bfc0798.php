...
<meta name="description" content="江苏大学理学院由原江苏理工大学理学院、镇江师专数学系和物理系、镇江医学院数学教研室和物理教研室组成。经学科调整和发展，现有数学、物理、工程力学和土木工程四个系，物理、力学两个校实验中心，土木工程专业实验室，数学建模实验室，理学院涵盖 数学、物理学、力学 和 土木工程 四个一级学科。"/>
<meta name="keywords" content="江苏大学理学院,江大理学院官网"/>
...
<body>
	...
	<div class="top">
		...
		<script language="JavaScript" src="/fos/Home/Tpl/Public/mm_menu.js"></script>
...
<div class="topLine bcm">
  <div class="container">
    <div class="row">
      ...
      <div class="w6 pull-left"><a href="mailto:lixue@ujs.edu.cn" title="lxydw@ujs.edu.cn">理学院信箱</a></div>
...
<div class="caidan">
  <ul>
    ...
    <li><a href="__APP__/Index/primary" name="link2" id="link2" onmouseover="MM_showMenu(window.mm_menu_0529185220_0,-23,40,null,'link2')" onmouseout="MM_startTimeout();">学院概况</a></li>
    <li><a href="__APP__/Teacher/index" name="link4" id="link4" onmouseover="MM_showMenu(window.mm_menu_0529192200_0,-20,40,null,'link4')" onmouseout="MM_startTimeout();">师资队伍</a></li>
    ...
    <li><a href="__APP__/Index/dqgz" name="link12" id="link12" onmouseover="MM_showMenu(window.mm_menu_0529202618_0,-18,40,null,'link12')" onmouseout="MM_startTimeout();">党群工作</a></li>
...
<!-- end class="nav" -->
	...
	<div class="container article">
		...
		<div class="row">
			...
			<div class="w2 pull-left mr20" style="padding-left:0;padding-right:5px;">

				<div class="tipsImages mt20 tipsTitle">

					<!-- 

					<img src="__PUBLIC__/Images/tubiao1.png"/>

					<img src="__PUBLIC__/Images/tubiao1.png"/>

					<img src="__PUBLIC__/Images/inter.jpg"/>

					<img src="__PUBLIC__/Images/phylab.jpg"/>

					<img src="__PUBLIC__/Images/phylab.jpg"/>

					 -->

					 <div class="even"><a href="http://edep.ujs.edu.cn">能源与环保战略研究中心</a></div>

					 <div class="odd"><a href="__APP__/Kyjg/show/id/1">非线性科学研究中心</a></div>

					 <div class="even"><a href="http://fos.ujs.edu.cn/study">生物光学及成像技术研究中心</a></div>

					 <div class="odd"><a href="http://phylab.ujs.edu.cn/">大学物理省级实验示范中心</a></div>

					 <div class="even"><a href="http://fos.ujs.edu.cn/newfos/shumo/">数学建模（创新工作室）</a></div>

					 <div class="odd"><a href="http://www.arcadia-china.com/">阿卡迪亚大学·中国项目</a></div>

					  <div class="even"><a href="http://foreign.ujs.edu.cn/about/hzbx/index.html">中外合作办学专栏</a></div>

					   <div class="odd"><a href="__APP__/Kyjg/show/id/4">非线性科学国际杂志编辑部</a></div>

					    <div class="even"><a href="__APP__/Kyjg/show/id/5">数学教育研究编辑部</a></div>
				 ...
				 <!--  换个样式试试 四格型
					 	...
					 	<div>
					 		...
					 		<a href="#"><img src="__PUBLIC__/Images/tubiao1.png"/></a>

							<a href="http://phy.ujs.edu.cn" target="_blank"><img src="__PUBLIC__/Images/physics.png"/></a>

					 	</div>

					 	<div style="padding:5px 0;border-bottom:3px solid #F3D55E;width:150px;">

					 		<a href="#"><img src="__PUBLIC__/Images/math.png"/></a>

							<a href="#"><img src="__PUBLIC__/Images/tubiao2.png"/></a>

					 	</div>

				-->

				<a href="http://phy.ujs.edu.cn" class="tipa"><img src="__PUBLIC__/Images/dw.jpg"/></a>

				

				<a href="#" class="tipa"><img src="__PUBLIC__/Images/sx.jpg"/></a>
			...
			<div class="w10 pull-right">

				<div class="">

					<div class="w8 pull-left">
							...
							<ul class="slides">
								...
								<li>
									...
									<a title="" target="_blank" href="#">
										...
										<img width="600px" height="auto" alt="" style="background: url(__PUBLIC__/Images/<?php echo ($data[0][pic_path]); ?>) no-repeat center;" src="__PUBLIC__/Images/alpha.png">
								...
								<li>
									...
									<a title="" href="#">
										...
										<img width="600px" height="auto" alt="" style="background: url(__PUBLIC__/Images/<?php echo ($data[1][pic_path]); ?>) no-repeat center;" src="__PUBLIC__/Images/alpha.png">
								...
								<li>
									...
									<a title="" href="#">
										...
										<img width="600px" height="auto" alt="" style="background: url(__PUBLIC__/Images/<?php echo ($data[2][pic_path]); ?>) no-repeat center;" src="__PUBLIC__/Images/alpha.png">
						...
						<script src="/fos/Public/Js/jquery-1.10.2.min.js"></script>

						<script src="/fos/Public/Js/slider.js"></script>
					...
					<div class="w4 pull-left" style="padding:0px;">
						...
						<div id="tabbox" class="mt20">

						    <ul class="atabs" id="tabs2">

						        <li><a href="__APP__/News/listn/id/1" style="cursor:default">本科生教育</a></li>

						       <li><a href="__APP__/News/listn/id/2" style="cursor:default">研究生教育</a></li>
						    ...
						    <ul class="tab_conbox" id="tab_conbox2">
						        ...
						        <li class="tab_con">
						           ...
						           <div class="tab_libox">
									   ...
									   <?php if(is_array($bkjy)): $i = 0; $__LIST__ = $bkjy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="bkjy">
												<a href="__APP__/News/index/newsid/<?php echo ($vo["news_id"]); ?>" title="<?php echo ($vo["news_title"]); ?>">
													<span><?php echo ($vo["news_title"]); ?></span><!--<?php if($i < 4): ?>111<?php endif; ?> -->
													<span><small><?php echo (date('Y-m-d',$vo["news_time"])); ?></small></span>
												</a>
											</div><?php endforeach; endif; else: echo "" ;endif; ?>

										<a href="__APP__/News/listn/id/1" style="display:inline-block; width:50px;margin-left:235px;">more&gt;&gt;</a>
						        ...
						        <li class="tab_con">
						        	...
						        	<div class="tab_libox">
										...
										<?php if(is_array($yjsjy)): $i = 0; $__LIST__ = $yjsjy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="yjsjy">
											<a href="__APP__/News/index/newsid/<?php echo ($vo["news_id"]); ?>" title="<?php echo ($vo["news_title"]); ?>">
										...
										<a href="__APP__/News/listn/id/2" style="display:inline-block; width:50px;margin-left:235px;">more&gt;&gt;</a>
				...
				<div class="row">
					...
					<div class="mt20 col-xs-4">

						<div class="panelInfo">

						    <div class="panelTitle">

						        <span class="h3">新闻公告</span><a href="__APP__/News/listn/id/3">more&gt;&gt;</a>
							...
							<div class="panelBody">
								...
								<ul><!-- 数据库读出数据 -->
									...
									<?php if(is_array($xyxw)): $i = 0; $__LIST__ = $xyxw;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="xyxw">
										<a href="__APP__/News/index/newsid/<?php echo ($vo["news_id"]); ?>" title="<?php echo ($vo["news_title"]); ?>">
											<span><?php echo ($vo["news_title"]); ?></span>
											<span><small><?php echo (date('Y-m-d',$vo["news_time"])); ?></small></span>
										</a>
					...
					<div class="panelInfo">
						    ...
						    <div class="panelTitle">
						        ...
						        <span class="h3">学术动态</span><a href="__APP__/News/listn/id/4">more&gt;&gt;</a>
							...
							<div class="panelBody">
								...
								<ul><!-- 数据库读出数据 -->
									...
									<?php if(is_array($ggfw)): $i = 0; $__LIST__ = $ggfw;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="ggfw">
									<a href="__APP__/News/index/newsid/<?php echo ($vo["news_id"]); ?>" title="<?php echo ($vo["news_title"]); ?>">
										<span><?php echo ($vo["news_title"]); ?></span>
										<span><small><?php echo (date('Y-m-d',$vo["news_time"])); ?></small></span>
									</a>
					...
					<div  class="mt20 col-xs-4">
						...
						<div class="panelInfo">
							    ...
							    <div class="panelTitle">
							        ...
							        <span class="h3">学生活动</span><a href="__APP__/News/listn/id/5">more&gt;&gt;</a>
								...
								<div class="panelBody">
									...
									<ul><!-- 数据库读出数据 -->
										...
										<?php if(is_array($xxhd)): $i = 0; $__LIST__ = $xxhd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="xxhd">
										<a href="__APP__/News/index/newsid/<?php echo ($vo["news_id"]); ?>" title="<?php echo ($vo["news_title"]); ?>">
											<span><?php echo ($vo["news_title"]); ?></span>
											<span><small><?php echo (date('Y-m-d',$vo["news_time"])); ?></small></span>
										</a>
...
<!-- 				<div class="clearfix"></div> -->
		...
		</div><!-- end class="row"包裹上面的row -->

		<div class="row mt15">

				<div id="list" class="picutre_many"

			        style="overflow: hidden; height: 150px;border:2px solid #eee; border-top:2px solid #F3D55E;">

			        <table cellspacing="0" cellpadding="0"

			            style="border: 0px;" class="container">
			                ...
			                <td id="list1">
			                    ...
			                    <table style="border: 0px;" cellpadding="0" cellspacing="0">
			                        ...
			                        <tr id="pic">
			                            ...
			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a1.jpg" title="阿卡迪亚大学学生访学" /></a></td>

			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a2.jpg" title="阿卡迪亚大学学生访学1" /></a></td>

			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a3.jpg" title="阿卡迪亚大学学生访学2" /></a></td>

			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a4.jpg" title="第四届数学青年教师讲课竞赛" /></a></td>

			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a5.jpg" title="第四届数学青年教师讲课竞赛证书" /></a></td>

			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a6.jpg" title="江苏大学春季长跑" /></a></td>

			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a7.jpg" title="施大宁教授专题报告" /></a></td>

			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a8.jpg" title="施大宁教授专题报告1" /></a></td>

			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a9.jpg" title="校第七届讲课比赛" /></a></td>
			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a10.jpg" title="校第七届讲课比赛1" /></a></td>
			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a11.jpg" title="镇江长跑锦标赛" /></a></td>
			                            <td><a href="#"><img alt="" src="__PUBLIC__/Images/a12.jpg" title="祝世宁院士报告" /></a></td>
...
<div class="container text-center" style="line-height:35px;padding-top:0;"><a href="http://fos.ujs.edu.cn/newfos/">【旧版本】</a>&nbsp;&nbsp;&nbsp;&nbsp;江苏大学理学院&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&copy;2010-<span id="curyear"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址：江苏省镇江市学府路301号70信箱&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;邮编：212013&nbsp;&nbsp;电话：0511-88780161
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var ggfw = $(".ggfw");
			var xxhd = $(".xxhd");
			for(i=0;i<bkjy.length;i++)
			{
				var item = bkjy.eq(i).find("small").text();
				if(Date.parse(item)+7*oneday>=Date.parse(curDate))
				{
					bkjy.eq(i).find("span").addClass("fontred");
				}
			}
			for(i=0;i<yjsjy.length;i++)
			{
				var item = yjsjy.eq(i).find("small").text();
				if(Date.parse(item)+7*oneday>=Date.parse(curDate))
				{
					yjsjy.eq(i).find("span").addClass("fontred");
				}
			}
			for(i=0;i<xyxw.length;i++)
			{
				var item = xyxw.eq(i).find("small").text();
				if(Date.parse(item)+3*oneday>=Date.parse(curDate))
				{
					xyxw.eq(i).find("span").addClass("fontred");
				}
			}
			for(i=0;i<ggfw.length;i++)
			{
				var item = ggfw.eq(i).find("small").text();
				if(Date.parse(item)+7*oneday>=Date.parse(curDate))
				{
					ggfw.eq(i).find("span").addClass("fontred");
				}
			}
			for(i=0;i<xxhd.length;i++)
			{
				var item = xxhd.eq(i).find("small").text();
				if(Date.parse(item)+7*oneday>=Date.parse(curDate))
				{
					xxhd.eq(i).find("span").addClass("fontred");
				}
			}
			//$("font").parent().find("span").addClass("fontred");
		});
	</script>
</body>
