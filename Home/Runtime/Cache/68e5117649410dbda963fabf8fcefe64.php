		...
		<div class="w10 pull-left">
			<div class="article">
				...
				<div class="articleBody w9 center-block">
					<ul>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/News/index/newsid/<?php echo ($vo["news_id"]); ?>" class="newsList"><?php echo ($vo["news_title"]); ?></a><a href="__APP__/News/index/id/<?php echo ($vo["news_id"]); ?>" class="newsTime"><?php echo (date('[Y-m-d]',$vo["news_time"])); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
