		...
		<div class="w10 pull-left">
			<div class="article">
				...
				<div class="articleBody w9 center-block">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 5 );++$i; if(($mod) == "0"): ?><tr><?php endif; ?>
						<td>						<?php if(($vo["person_desc"]) == ""): echo ($vo["person_name"]); ?>						<?php else: ?>						<a href="__APP__/Teacher/show/id/<?php echo ($vo["person_id"]); ?>"><?php echo ($vo["person_name"]); ?></a><?php endif; ?>						</td>
						<?php if(($mod) == "4"): ?></tr><?php endif; endforeach; endif; else: echo "" ;endif; ?>
					<e condition="$list|count % 5 neq 0"></tr>
					</table>
				</div><!-- articleBody -->
			</div><!-- article -->
		</div><!-- w10 -->
