		...
		<div class="w10 pull-left">
			<div class="article">
				...
				<ul class="listContent">
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span class="icon-link"></span><a href="__APP__/Kyjg/show/id/<?php echo ($vo["institution_id"]); ?>"><?php echo ($vo["institution_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						<!--因为数据超出富文本编辑限制，应用系统分析研究所采用静态页面-->
						<li><span class="icon-link"></span><a href="__APP__/Kyjg/yyxtfx">应用系统分析研究所</a></li>
		        </ul>
    			</div>
				</div>
			</div>
