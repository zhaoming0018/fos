...
<title><?php echo ($person["person_name"]); ?>——简介</title>
</head>
<body>
<div class="top">
		...
		<div class="w10 pull-left">
			<div class="article">
				...
				<div class="w9 center-block">
					<div>
						<img src="__PUBLIC__/upload/file/person/<?php echo ($person["person_photo"]); ?>" class="onePicture"/>
						<div class="text-right"><?php echo ($person["person_name"]); ?></div>
						<!-- 举例说明 -->
					</div>
					<hr style="width:500px;margin:10px auto;"/>
					<div>
						<h4><span class="icon-map-marker"></span>个人简介</h4>
						<div class="span1 text-indent articleBody">
							<?php echo ($person["person_desc"]); ?>
						</div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>研究生招生专业</h4>
						<div class="span1">
						  	<?php echo ($person["person_yjszszy"]); ?>
						</div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>研究方向</h4>
						<div class="span1">
						 	<?php echo ($person["person_research_direction"]); ?>
						</div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>
							联系电话
						</h4>
						<div class="span1"><?php echo ($person["person_tel"]); ?></div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>电子邮件</h4>
						<div class="span1"><?php echo ($person["person_email"]); ?></div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>联系地址</h4>
						<div class="span1"><?php echo ($person["person_address"]); ?></div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>讲授课程</h4>
						<div class="span1"> 
						<div>一、研究生课程</div>

						   <div> <?php echo ($person["person_yjskc"]); ?></div>
						
						
							<div>二、本科生课程</div>
						
							<div><?php echo ($person["person_bkskc"]); ?></div>

						</div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>教学研究课题</h4>
						<div class="span1">

						    <?php echo ($person["person_jxyjkt"]); ?>

						</div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>教材</h4>
						<div class="span1"><?php echo ($person["person_book"]); ?></div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>学术研究课题</h4>
						<div class="span1"> <?php echo ($person["person_xsyjkt"]); ?></div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>专著</h4>
						<div class="span1"><?php echo ($person["person_zz"]); ?></div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>学术论文</h4>
						<div class="span1">
					
						<?php echo ($person["person_xslw"]); ?>

						</div>
					</div>
					
					<div>
						<h4><span class="icon-map-marker"></span>表彰/奖励</h4>
						<div class="span1">
					
					    <?php echo ($person["person_bzjl"]); ?>
